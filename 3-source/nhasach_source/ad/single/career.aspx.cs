...
public partial class ad_single_career : System.Web.UI.Page
{
    ...
    void DeleteDownload(string strDownloadName)
    {
        ...
        {
            var strFilePath = Server.MapPath("~/res/career/download/" + strDownloadName);
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strFilePath = FileFilePath.UploadedFiles.Count > 0 ? FileFilePath.UploadedFiles[0].GetName() : "";
            ...
            if (e.CommandName == "PerformInsert")
            {
                ...
                strCareerID = oCareer.CareerID;
                strFilePath = (string.IsNullOrEmpty(strConvertedCareerTitle) ? "" : strConvertedCareerTitle + "-") + strCareerID + strFilePath.Substring(strFilePath.LastIndexOf('.'));

                string strFullPath = "~/res/career/" + strImageName;
                string strFullFilePath = "~/res/career/download/" + strFilePath;
            ...
            else
            {
                ...
                dsUpdateParam["FilePath"].DefaultValue = strFilePath;
                ...
                if (!string.IsNullOrEmpty(strFilePath))
                {
                    ...
                    string strFullPath = "~/res/career/download/" + strFilePath;
