<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="info.aspx.cs" Inherits="ad_single_product" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="Tag" HeaderText="Tên công ty" SortExpression="Tag" />
                    <asp:GridBoundColumn DataField="ProductName" HeaderText="Email" SortExpression="ProductName" />
                                                ...
                                                <table class="search">
                                                    <tr class="invisible">
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 54px x 60px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="9" Name="CategoryID" PropertyName="SelectedValue"
                Type="String" />
