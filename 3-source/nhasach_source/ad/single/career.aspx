<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="career.aspx.cs" Inherits="ad_single_career" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <h3 class="mainTitle">
        <img alt="" src="../assets/images/career.png" class="vam" />
        Tuyển Dụng
    </h3>
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="False">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchCareerTitle" runat="server" Width="130px">
                        </asp:RadTextBox>
                    </td>
                    <td class="left">
                        Mô tả
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadComboBox Filter="Contains" ID="ddlSearchCategory" runat="server" DataSourceID="ObjectDataSource2"
                            DataTextField="CareerCategoryName" DataValueField="CareerCategoryID" OnDataBound="DropDownList_DataBound"
                            Width="134px">
                        </asp:RadComboBox>
                    </td>
                    <td class="left">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN" AllowPaging="True" 
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn HeaderText="ID" DataField="CareerID" SortExpression="CareerID" Visible="False">
                    </asp:GridBoundColumn>
                    <asp:GridBoundColumn DataField="CareerTitle" HeaderText="Tiêu đề" SortExpression="CareerTitle" />
                    <asp:GridBoundColumn DataField="CareerTitleEn" HeaderText="Tiêu đề (En)" SortExpression="CareerTitleEn" Visible="False" />
                    <asp:GridBoundColumn DataField="CareerCategoryName" HeaderText="Danh mục" SortExpression="CareerCategoryName" Visible="False" />
                    ...
                    <asp:GridTemplateColumn DataField="ImageName" HeaderText="Ảnh" SortExpression="ImageName" Visible="False">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageName").ToString()) ? false : true %>'>
                                <img alt="" src='<%# "~/res/career/thumbs/" + Eval("ImageName") %>' width="80" runat="server"
                                    visible='<%# string.IsNullOrEmpty(Eval("ImageName").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("CareerID") + "#" + Eval("ImageName") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            ...
                            <asp:HiddenField ID="hdnCareerID" runat="server" Value='<%# Eval("CareerID") %>' />
                            ...
                            <table class="search">
                                ...
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlCategory" runat="server" DataSourceID="ObjectDataSource2"
                                            DataTextField="CareerCategoryName" DataValueField="CareerCategoryID" Width="504px"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCareerTitle" runat="server" Text='<%# Bind("CareerTitle") %>'
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCareerTitleEn" runat="server" Text='<%# Bind("CareerTitleEn") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            ...
            <asp:TextBoxSetting EmptyMessage="Tiêu đề ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtCareerTitle" />
                </TargetControls>
            </asp:TextBoxSetting>
            <%-- Tieng Anh--%>
            ...
            <asp:TextBoxSetting EmptyMessage="Tiêu đề(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtCareerTitleEn" />
                </TargetControls>
            </asp:TextBoxSetting>
        </asp:RadInputManager>
    </asp:RadAjaxPanel>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="CareerSelectAll"
        TypeName="TLLib.Career" DeleteMethod="CareerDelete" UpdateMethod="CareerUpdate">
        <DeleteParameters>
            <asp:Parameter Name="CareerID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
            <asp:Parameter Name="StartRowIndex" Type="String" />
            <asp:Parameter Name="EndRowIndex" Type="String" />
            <asp:Parameter Name="Keyword" Type="String" />
            <asp:ControlParameter ControlID="txtSearchCareerTitle" Name="CareerTitle" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="txtSearchDescription" Name="Description" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" Name="CareerCategoryID" PropertyName="SelectedValue"
                Type="String" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="CareerCategorySelectAll"
        TypeName="TLLib.CareerCategory"></asp:ObjectDataSource>
