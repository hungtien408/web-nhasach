                        ...
                        <ItemTemplate>
                            <div style="width: 72px">
                                <img alt="Thư viện ảnh" title="Thư viện ảnh" src="../assets/images/PhotoAlbum.png"
                                    onclick="openWindow('servicephotoalbum.aspx?PI=<%# Eval("ProductID") %>','Thư viện ảnh')"
                                    style="cursor: pointer" />
                                <img alt="Banner" title="Banner" src="../assets/images/advertisement.png"
                                    onclick="openWindow('bannersub.aspx?PI=<%# Eval("ProductID") %>','Banner')"
                                    style="cursor: pointer" />
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 580px x 485px)</span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadEditor ID="txtDescription" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("Description") %>'>
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 80px x 80px)</span>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="txtSearchPriceTo" Name="PriceTo" PropertyName="Text"
                Type="String" />
            <asp:ControlParameter ControlID="ddlSearchCategory" DefaultValue="5" Name="CategoryID"
