    ...
    public class Career
    {
        ...
        )
        {
            try
            {
                ...
                SqlParameter careerIDParam = new SqlParameter("@OutCareerID", null);
                SqlParameter errorCodeParam = new SqlParameter("@ErrorCode", null);
                imageNameParam.Size = 100;
                errorCodeParam.Size = careerIDParam.Size = 4;
                errorCodeParam.Direction = imageNameParam.Direction = careerIDParam.Direction = ParameterDirection.Output;
                cmd.Parameters.Add(imageNameParam);
                cmd.Parameters.Add(careerIDParam);
                ...
                m_CareerID = careerIDParam.Value.ToString();
        ...
        {
            get { return m_CareerID; }
            set { m_CareerID = value; }
        }
