...
namespace TLLib
{
    public class AdsBanner
    {
        ...
        public string AdsBannerInsert1(
            string FileName,
            string ConvertedAdsBannerName,
            string AdsCategoryID,
            string ProductID,
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_AdsBanner_Insert1", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@FileName", string.IsNullOrEmpty(FileName) ? dbNULL : (object)FileName);
                cmd.Parameters.AddWithValue("@ConvertedAdsBannerName", string.IsNullOrEmpty(ConvertedAdsBannerName) ? dbNULL : (object)ConvertedAdsBannerName);
                cmd.Parameters.AddWithValue("@AdsCategoryID", string.IsNullOrEmpty(AdsCategoryID) ? dbNULL : (object)AdsCategoryID);
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_AdsBanner_Insert1' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        )
        {
            ...
            {
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_AdsBanner_Update1", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@AdsBannerID", string.IsNullOrEmpty(AdsBannerID) ? dbNULL : (object)AdsBannerID);
                cmd.Parameters.AddWithValue("@FileName", string.IsNullOrEmpty(FileName) ? dbNULL : (object)FileName);
                cmd.Parameters.AddWithValue("@ConvertedAdsBannerName", string.IsNullOrEmpty(ConvertedAdsBannerName) ? dbNULL : (object)ConvertedAdsBannerName);
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_AdsBanner_Update1' reported the ErrorCode : " + errorCodeParam.Value.ToString());
        ...
        public DataTable AdsBannerSelectAll1(
            string StartRowIndex,
            string EndRowIndex,
            string AdsCategoryID,
            string ProductID,
        ...
        )
        {
            try
            {
                var dt = new DataTable();
                var scon = new SqlConnection(connectionString);
                var cmd = new SqlCommand("usp_AdsBanner_SelectAll1", scon);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                if (errorCodeParam.Value.ToString() != "0")
                    throw new Exception("Stored Procedure 'usp_AdsBanner_SelectAll1' reported the ErrorCode : " + errorCodeParam.Value.ToString());
